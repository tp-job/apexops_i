        ...
        <div className="flex flex-col gap-2 w-full max-w-sm text-sm z-50 animate-slide-in-right">
            <div className="success-alert cursor-default flex items-center justify-between w-full min-h-[3.5rem] rounded-xl bg-light-surface dark:bg-dark-surface px-4 py-3 shadow-lg border border-global-green/20 dark:border-global-green/30 backdrop-blur-sm">
                <div className="flex gap-3 items-start flex-1">
                    {/* Icon */}
                    <div className="text-global-green bg-global-green/10 dark:bg-global-green/20 backdrop-blur-xl p-2 rounded-xl flex-shrink-0">
                ...
                {showClose && onClose && (
                    <button
                        onClick={onClose}
                        className="text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary hover:bg-light-surface-2 dark:hover:bg-dark-surface-2 p-1.5 rounded-xl transition-colors ease-linear flex-shrink-0 ml-2"
                        aria-label="Close"
                    >
