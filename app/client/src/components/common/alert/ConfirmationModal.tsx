            ...
            <div className="bg-light-surface dark:bg-dark-surface rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl border border-light-border dark:border-dark-border transform transition-all duration-300 scale-100 animate-modal-in">
                ...
                <div className="flex items-start gap-4 mb-4">
                    ...
                    {!isConfirming && (
                        <button
                            onClick={onClose}
                            className="text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary hover:bg-light-surface-2 dark:hover:bg-dark-surface-2 p-1.5 rounded-xl transition-colors flex-shrink-0"
                            aria-label="Close"
                        >
