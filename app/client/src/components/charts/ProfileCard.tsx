    ...
    return (
        <div className="rounded-2xl overflow-hidden bg-white border-light-border dark:bg-dark-surface dark:border-dark-border border">
            ...
            <div className="relative h-28 bg-gradient-to-br from-navy via-indigo to-wine overflow-hidden">
                ...
                {/* Settings Button */}
                <button className="absolute top-4 right-4 p-2 rounded-xl bg-white/10 hover:bg-white/20 transition-colors backdrop-blur-sm">
            ...
            <div className="px-6 pt-4 pb-6">
                ...
                <div className="p-3 rounded-xl mb-4 bg-light-surface-2 dark:bg-dark-surface-2">
                    ...
                    <div className="flex gap-1.5">
                        {['ðŸ†', 'â­', 'ðŸŽ¯', 'ðŸ’Ž', 'ðŸ”¥'].map((badge, i) => (
                            <div 
                                key={i}
                                className="w-8 h-8 rounded-xl flex items-center justify-center text-sm bg-white dark:bg-dark-surface shadow-sm"
                            >
                                {badge}
                            </div>
                        ))}
                        <div className="w-8 h-8 rounded-xl flex items-center justify-center text-xs font-bold bg-white text-light-text-secondary dark:bg-dark-surface dark:text-dark-text-secondary shadow-sm">
                            +7
                        </div>
                    </div>
                </div>
                ...
                {/* Action Button */}
                <button className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-primary to-blue-primary text-white font-medium flex items-center justify-center gap-2 hover:shadow-lg hover:/25 transition-all duration-300 hover:-translate-y-0.5">
