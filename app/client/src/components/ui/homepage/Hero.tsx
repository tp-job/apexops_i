        ...
        <main className="w-full h-screen bg-transparent overflow-hidden relative transition-colors duration-300">
            <section className="relative z-10 flex flex-col items-center justify-center h-[calc(100vh-80px)] px-6">
                <div className="flex items-center gap-2 mb-8">
                    <div className="w-8 h-8 bg-gradient-to-br from-blue-primary to-orange-primary rounded-xl transform rotate-45"></div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                    <Link to="/dashboard" className="bg-light-text-primary dark:bg-white text-dark-text-primary dark:text-light-text-primary px-8 py-4 rounded-full flex items-center gap-3 hover:bg-light-text-primary/90 dark:hover:bg-white/90 transition-all text-lg cursor-pointer shadow-lg">
