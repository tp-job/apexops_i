        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            <div className="lg:col-span-6 flex flex-col justify-between h-full space-y-12 relative">
                ...
                <div className="relative pl-8 border-l-2 border-[var(--color-violet)]/50 backdrop-blur-sm bg-white/5 p-6 rounded-r-xl border-t border-b border-white/10">
                    <p className="text-xl text-dark-text-secondary font-light leading-relaxed italic font-display">"The best and most beautiful things in the world cannot be seen or even touched - they must be felt with the heart."
                    </p>
                    <p className="mt-4 text-[10px] uppercase tracking-[0.15em] text-[var(--color-blue-primary)] font-bold">â€” Helen Keller</p>
                </div>
            </div>
