            ...
            <div className="border-t border-gray-200 dark:border-dark-border p-4">
                <div className="flex items-center gap-3">
                    <input
                        ...
                        className="flex-1 px-4 py-2 rounded-xl outline-none transition bg-white border-gray-300 text-gray-900 focus:ring-2 focus:ring-ember dark:bg-dark-surface dark:border-dark-border dark:text-dark-text-primary border focus:border-transparent"
                    />
                    <button
                        onClick={handleSend}
                        disabled={!input.trim()}
                        className="flex items-center gap-2 px-4 py-2 rounded-xl transition bg-ember hover:bg-wine disabled:opacity-50 disabled:cursor-not-allowed text-white"
                    >
