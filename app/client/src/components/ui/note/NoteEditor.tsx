...
// â”€â”€ TipTap Editor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const editor = useEditor({
        ...
        onSelectionUpdate: ({ editor }) => {
            ...
            if (selectedText.trim().length > 0) {
                // è®¡ç®—è¡Œå·ï¼šè®¡ç®—é€‰ä¸­æ–‡æœ¬ä¹‹å‰çš„æ¢è¡Œç¬¦æ•°é‡
...
if (result.success && result.data) {
    ...
    // à¸›à¸´à¸” Comment dialog à¹€à¸¡à¸·à¹ˆà¸­à¸„à¸¥à¸´à¸à¸™à¸­à¸à¸«à¸£à¸·à¸­à¸à¸” Escape
    useEffect(() => {
        ...
        <div className="flex flex-col h-screen overflow-hidden bg-white dark:bg-dark-bg transition-colors duration-300 font-sans antialiased text-light-text dark:text-dark-text">
            ...
            <header className="h-14 bg-white/60 dark:bg-dark-bg/60 backdrop-blur-md fixed top-0 w-full z-50 flex items-center justify-between px-6 border-b border-light-border dark:border-dark-border">
                    ...
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/note')}>
                        <div className="w-8 h-8 bg-linear-to-br from-blue-primary to-blue-secondary rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">S</div>
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="bg-blue-primary hover:bg-blue-600 text-white px-4 py-1.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all shadow-lg"
                    >
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">
                                    {notesLoading ? 'Loadingâ€¦' : `${notesList.length} documents`}
                                </p>
                            </div>
                            <button
                                onClick={() => navigate('/note-editor')}
                                className="p-1.5 rounded-xl hover:bg-light-surface-2 dark:hover:bg-dark-surface-2 text-light-text-secondary dark:text-dark-text-secondary"
                            >
                    ...
                    <div className="sticky top-0 z-10 w-full bg-dark-bg/95 backdrop-blur-md px-6 lg:px-8 py-3 flex items-center justify-between border-b border-dark-border">
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.18em]">
                                <span className="px-2.5 py-1 rounded-xl bg-blue-primary/15 text-blue-primary border border-blue-primary/30">Home</span>
                                <span className="px-2.5 py-1 rounded-xl text-dark-text-secondary hover:bg-dark-surface/80 hover:text-white transition-colors cursor-pointer">Insert</span>
                                <span className="px-2.5 py-1 rounded-xl text-dark-text-secondary hover:bg-dark-surface/80 hover:text-white transition-colors cursor-pointer">Layout</span>
                                <span className="px-2.5 py-1 rounded-xl text-dark-text-secondary hover:bg-dark-surface/80 hover:text-white transition-colors cursor-pointer hidden md:inline-flex">View</span>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-1 rounded-xl bg-dark-surface/60 px-1 py-0.5 border border-dark-border/70">
                                    <button
                                        ...
                                        className="p-1.5 rounded-xl hover:bg-dark-surface text-dark-text-secondary hover:text-blue-primary transition-colors disabled:opacity-40"
                                    >
                                ...
                                <div className="hidden md:flex items-center gap-1 rounded-xl bg-dark-surface/60 px-2 py-0.5 border border-dark-border/70">
                                    ...
                                    <button
                                        ...
                                        className={`px-2 py-1 rounded-xl text-xs font-semibold italic transition-colors ${
                                    ...
                                    <button
                                        ...
                                        className={`px-2 py-1 rounded-xl text-xs font-semibold underline transition-colors ${
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button onClick={handleSave} className="p-2 rounded-xl bg-blue-primary/10 text-blue-primary hover:bg-blue-primary hover:text-white transition-all"><span className="material-symbols-outlined text-[20px]">save</span></button>
                        </div>
                    </div>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <div className="w-8 h-8 rounded-xl bg-blue-primary/20 flex items-center justify-center">
                                                ...
                                                <div className="mb-4 p-3 bg-dark-surface-2/50 rounded-xl border border-dark-border/30 text-xs">
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <span className="text-white italic break-words">"{selectedText.length > 60 ? selectedText.substring(0, 60) + '...' : selectedText}"
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <textarea
                                                        ...
                                                        rows={4}
                                                        className="w-full resize-none rounded-xl border border-dark-border bg-dark-surface-2 px-3 py-2.5 text-sm text-white placeholder:text-dark-text-secondary/60 focus:outline-none focus:ring-2 focus:ring-blue-primary/50 focus:border-blue-primary/50 transition-all"
                                                        autoFocus
                                                        onKeyDown={(e) => {
                                                    ...
                                                    <p className="mt-1.5 text-[10px] text-dark-text-secondary/70">
                                                        Press <kbd className="px-1.5 py-0.5 bg-dark-surface rounded text-[10px] font-mono">âŒ˜/Ctrl + Enter</kbd> to submit
                                                    </p>
                                                </div>
                                                ...
                                                <div className="flex items-center justify-end gap-2 pt-2 border-t border-dark-border/30">
                                                    <button
                                                        ...
                                                        className="px-4 py-2 rounded-xl text-xs font-medium bg-dark-surface-2 text-dark-text-secondary hover:text-white hover:bg-dark-surface transition-colors"
                                                    >
                                                        Cancel
                                                    </button>
                                                    <button
                                                        ...
                                                        className="px-4 py-2 rounded-xl text-xs font-semibold bg-blue-primary text-white hover:bg-blue-secondary disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-1.5 shadow-lg hover:shadow-xl hover:/30"
                                                    >
                            ...
                            <div className="space-y-6">
                                ...
                                <section>
                                    <div className="flex items-center justify-between gap-4 mb-4">
                                        ...
                                        <button
                                            type="button"
                                            className="px-3 py-1.5 rounded-xl text-xs font-medium bg-light-surface-2 dark:bg-dark-surface-2 text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary hover:bg-light-surface dark:hover:bg-dark-surface transition-colors"
                                        >
                                            + Add file
                                        </button>
                                    </div>
                                    <div className="grid grid-cols-1 gap-3">
                                        {DEMO_ATTACHMENTS.map((att) => (
                                            ...
                                            >
                                                <div className="w-9 h-9 rounded-xl bg-orange-primary/10 text-orange-primary flex items-center justify-center text-xs font-bold">
                                                    {att.type}
                                                </div>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    {c.selectedText && (
                                                        <div className="mb-1.5 px-2 py-1 bg-light-bg dark:bg-dark-bg rounded border border-light-border dark:border-dark-border">
                                                            <p className="text-[10px] text-light-text-secondary dark:text-dark-text-secondary font-mono italic">"{c.selectedText.length > 60 ? c.selectedText.substring(0, 60) + '...' : c.selectedText}"
                                                            </p>
                                                        </div>
                                                    )}
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex justify-end">
                                            <button
                                                ...
                                                disabled={!newCommentText.trim()}
                                                className="px-3 py-1.5 rounded-xl bg-orange-primary text-white text-xs font-semibold hover:bg-wine disabled:opacity-60"
                                            >
                                                Add comment
                                            </button>
                                        </div>
