                ...
                <div className="w-full max-w-2xl bg-surface-light dark:bg-surface-dark rounded-2xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 flex flex-col max-h-[90vh] overflow-hidden transition-all duration-300">
                        ...
                        <section>
                            ...
                            <div className="flex gap-2">
                                <div className="relative flex-1">
                                    ...
                                    <input className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary focus:border-primary transition-shadow" placeholder="Add emails or groups" type="email" />
                                </div>
                                <div className="relative w-32">
                                    <select className="w-full h-full pl-3 pr-8 py-2.5 bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark rounded-xl text-sm text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-primary focus:border-primary appearance-none cursor-pointer">
                                ...
                                <button className="px-5 py-2.5 bg-primary hover:bg-primary-hover text-white font-medium text-sm rounded-xl shadow-sm transition-colors flex items-center gap-1">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="flex-1 bg-white dark:bg-gray-900 border border-border-light dark:border-border-dark rounded-xl px-3 py-1.5 text-xs text-gray-500 dark:text-gray-400 truncate">
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between group">
                                    ...
                                    <div className="relative">
                                        <button className="text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-1.5 rounded-xl transition-colors flex items-center gap-1 group-hover:visible">
                                ...
                                <div className="flex items-center justify-between group">
                                    ...
                                    <div className="relative">
                                        <button className="text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-1.5 rounded-xl transition-colors flex items-center gap-1">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 px-6 py-4 flex justify-between items-center border-t border-border-light dark:border-border-dark">
                        ...
                        <div className="flex gap-3">
                            <button className="px-4 py-2 border border-border-light dark:border-border-dark text-gray-700 dark:text-gray-300 rounded-xl text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                Cancel
                            </button>
                            <button className="px-6 py-2 bg-primary text-white rounded-xl text-sm font-medium hover:bg-primary-hover shadow-lg shadow-primary/20 transition-all">
                                Done
                            </button>
                        </div>
                    </div>
