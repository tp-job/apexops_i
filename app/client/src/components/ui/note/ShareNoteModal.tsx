            ...
            <div className="relative w-full max-w-2xl bg-light-surface dark:bg-dark-surface rounded-2xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-300">
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-light-border dark:border-dark-border">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-blue-primary/10 rounded-xl text-blue-secondary">
                    ...
                    <section>
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <input
                                    className="w-full pl-10 pr-4 py-2.5 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-xl text-sm text-light-text dark:text-dark-text placeholder-light-text-secondary dark:placeholder-dark-text-secondary focus:ring-2 focus:ring-blue-primary focus:border-blue-primary transition-all outline-none"
                                    placeholder="Add emails or groups"
                                    type="email"
                                />
                            </div>
                            <div className="relative w-32">
                                <select className="w-full h-full pl-3 pr-8 py-2.5 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-xl text-sm text-light-text dark:text-dark-text focus:ring-2 focus:ring-blue-primary focus:border-blue-primary appearance-none cursor-pointer outline-none">
                            ...
                            <button className="px-5 py-2.5 bg-blue-primary hover:bg-blue-600 text-white font-medium text-sm rounded-xl shadow-sm transition-colors flex items-center gap-1">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="flex-1 bg-white dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-xl px-3 py-1.5 text-xs text-light-text-secondary dark:text-dark-text-secondary truncate font-mono">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between group">
                                ...
                                <button className="text-xs font-medium text-light-text-secondary dark:text-dark-text-secondary hover:bg-light-surface-2 dark:hover:bg-dark-surface-2 px-3 py-1.5 rounded-xl transition-colors flex items-center gap-1">
                ...
                <div className="bg-light-bg dark:bg-dark-bg/50 px-6 py-4 flex justify-between items-center border-t border-light-border dark:border-dark-border">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={onClose}
                            className="px-4 py-2 border border-light-border dark:border-dark-border text-light-text-secondary dark:text-dark-text-secondary rounded-xl text-sm font-medium hover:bg-light-surface-2 dark:hover:bg-dark-surface-2 transition-colors"
                        >
                            Cancel
                        </button>
                        <button
                            onClick={onClose}
                            className="px-6 py-2 bg-blue-primary text-white rounded-xl text-sm font-medium hover:bg-blue-600 shadow-lg transition-all font-bold"
                        >
                            Done
                        </button>
                    </div>
