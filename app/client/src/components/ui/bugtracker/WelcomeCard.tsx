...
const WelcomeCard: FC<WelcomeCardProps> = ({ userName = 'Developer', ticketStats = { open: 0, inProgress: 0, resolved: 0, critical: 0 } }) => {
    ...
    return (
        <main className="relative overflow-hidden rounded-2xl">
            ...
            {/* decorative elements */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-brand-accent/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500/15 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
            {/* grid pattern */}
                    ...
                    <article className="space-y-4">
                        ...
                        <div>
                            <h1 className="text-3xl lg:text-4xl font-bold text-white mb-2 font-heading">
                                {greeting}, {userName}!
                                <i className="ri-sparkling-2-fill inline-block w-8 h-8 ml-2 text-brand-accent animate-pulse"></i>
                            </h1>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {ticketStats.critical > 0 && (
                                <span className="px-3 py-1.5 rounded-full bg-red-500/20 text-red-300 text-sm font-medium backdrop-blur-sm border border-red-500/30 flex items-center gap-1.5 animate-pulse">
