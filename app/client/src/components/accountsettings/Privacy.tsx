        ...
        <div className="space-y-6">
            <div className="bg-light-surface dark:bg-dark-surface backdrop-blur-sm border border-light-border dark:border-dark-border rounded-2xl p-6">
                ...
                <div className="space-y-4">
                    <div className="p-4 bg-blue-500/10 dark:bg-blue-500/20 border border-blue-500/20 dark:border-blue-500/30 rounded-xl">
            ...
            <div className="bg-red-500/10 dark:bg-red-500/20 backdrop-blur-sm border border-red-500/20 dark:border-red-500/30 rounded-2xl p-6">
                ...
                <button className="px-4 py-2 bg-red-600 hover:bg-red-700 dark:hover:bg-red-500 text-white rounded-xl text-sm font-medium transition-colors">
                    Delete Account
                </button>
            </div>
        </div>
