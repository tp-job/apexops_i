                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <button className="px-4 py-2 bg-global-blue hover:bg-blue-700 dark:hover:bg-blue-600 text-white rounded-xl text-sm font-medium transition-colors">
                                Upload
                            </button>
                            <button className="px-4 py-2 bg-light-surface-2 dark:bg-dark-border border border-light-border dark:border-dark-border text-light-text dark:text-dark-text hover:bg-light-surface dark:hover:bg-dark-surface rounded-xl text-sm font-medium transition-colors">
                                Remove
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border text-light-text dark:text-dark-text rounded-xl focus:outline-none focus:border-orange-primary transition-colors"
                            />
                        </div>
                    </div>
                    <div>
            ...
            <div className="bg-light-surface dark:bg-dark-surface border border-light-border dark:border-dark-border rounded-2xl p-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border text-light-text dark:text-dark-text rounded-xl focus:outline-none focus:border-orange-primary transition-colors appearance-none"
                            >
                ...
                <div className="mt-6">
                    ...
                    <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-3 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border text-light-text dark:text-dark-text rounded-xl focus:outline-none focus:border-orange-primary transition-colors resize-none"
                ...
                <div className="mt-6">
                    <button
                        onClick={handleSave}
                        className="px-4 py-2 bg-global-blue hover:bg-blue-700 dark:hover:bg-blue-600 text-white rounded-xl text-sm font-medium transition-colors"
                    >
                        Save Profile
                    </button>
                </div>
