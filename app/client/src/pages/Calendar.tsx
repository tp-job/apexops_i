...
const TEMPLATE = {
    primary: '#C5F43A', // brand-accent
    primaryGlow: 'rgba(197, 244, 58, 0.5)',
    secondary: '#3B82F6', // blue-500
    tertiary: '#EF4444', // red-500
    quaternary: '#F97316', // orange-500
    backgroundDark: 'transparent',
    surfaceDark: 'rgba(34, 34, 34, 0.85)', // glassDark
    surfaceDarkAlt: 'rgba(0, 0, 0, 0.4)',
    surfaceDarkCard: 'rgba(0, 0, 0, 0.2)',
    borderDark: 'rgba(255, 255, 255, 0.1)',
    headerBg: 'rgba(34, 34, 34, 0.95)',
};
...
const ScheduleModal: FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            ...
            <Box sx={{ position: 'fixed', bottom: 80, right: 80, width: 384, height: 384, bgcolor: TEMPLATE.secondary, opacity: 0.1, filter: 'blur(120px)', borderRadius: '50%', pointerEvents: 'none' }} />
        </Box>
    );
};
    ...
    return (
        <ThemeProvider theme={calendarTheme}>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                >
                    <Box sx={{ maxWidth: 1400, margin: '0 auto', mb: 3, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Box>
                            <Typography sx={{ fontFamily: '"DM Sans", sans-serif', fontWeight: 700, fontSize: '2.25rem', color: 'white' }}>
                                Calendar
                            </Typography>
                            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.5)', mt: 0.5 }}>
                                Deployments, releases & team schedule
                            </Typography>
                        </Box>
                    </Box>
