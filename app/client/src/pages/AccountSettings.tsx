...
const tabs = [
    { id: 'personal-info', label: 'à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ªà¹ˆà¸§à¸™à¸šà¸¸à¸„à¸„à¸¥', icon: 'ri-user-circle-fill' },
    { id: 'profile', label: 'à¹‚à¸›à¸£à¹„à¸Ÿà¸¥à¹Œ', icon: 'ri-user-circle-fill' },
    { id: 'security', label: 'à¸„à¸§à¸²à¸¡à¸›à¸¥à¸­à¸”à¸ à¸±à¸¢', icon: 'ri-key-fill' },
    { id: 'notifications', label: 'à¸à¸²à¸£à¹à¸ˆà¹‰à¸‡à¹€à¸•à¸·à¸­à¸™', icon: 'ri-notification-3-fill' },
    { id: 'privacy', label: 'à¸„à¸§à¸²à¸¡à¹€à¸›à¹‡à¸™à¸ªà¹ˆà¸§à¸™à¸•à¸±à¸§', icon: 'ri-lock-fill' },
];

// â”€â”€ Toggle button for theme / language â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const ToggleButton: FC<{
    ...
    <button
        ...
        className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${
            active
                ? 'bg-orange-primary text-white shadow-md /20'
...
const AccountSettings: FC = () => {
    ...
    const handleLanguageChange = async (lang: 'th' | 'en') => {
        ...
        try {
            await updateProfile({ language: lang === 'th' ? 'à¹„à¸—à¸¢ (Thai)' : 'English (US)' });
        } catch (err) {
    ...
    // â”€â”€ Guard states â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (authLoading) {
        return (
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                ...
                <div className="mb-10 animate-fade-in-up">
                    <h1 className={`text-3xl sm:text-4xl font-extrabold tracking-tight mb-2 ${textPrimary}`}>
                        à¸à¸²à¸£à¸•à¸±à¹‰à¸‡à¸„à¹ˆà¸²à¸šà¸±à¸à¸Šà¸µ
                    </h1>
                    <p className={textSecondary}>à¸­à¸±à¸›à¹€à¸”à¸•à¹‚à¸›à¸£à¹„à¸Ÿà¸¥à¹Œà¹à¸¥à¸°à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ªà¹ˆà¸§à¸™à¸•à¸±à¸§à¸‚à¸­à¸‡à¸„à¸¸à¸“</p>
                </div>
                ...
                <div className={`${card} ${sectionPad} mb-8 animate-fade-in-up`} style={{ animationDelay: '0.05s' }}>
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className={`text-lg font-bold mb-0.5 ${textPrimary}`}>à¸£à¸¹à¸›à¹‚à¸›à¸£à¹„à¸Ÿà¸¥à¹Œ</h3>
                            <p className={`text-sm mb-4 ${textSecondary}`}>à¸£à¸¹à¸›à¸™à¸µà¹‰à¸ˆà¸°à¹à¸ªà¸”à¸‡à¸šà¸™à¹‚à¸›à¸£à¹„à¸Ÿà¸¥à¹Œà¸‚à¸­à¸‡à¸„à¸¸à¸“</p>
                            <div className="flex items-center gap-3">
                                <button className={btnOutline}>à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¸£à¸¹à¸›</button>
                ...
                <div className={`${card} ${sectionPad} mb-10 animate-fade-in-up`} style={{ animationDelay: '0.1s' }}>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <h2 className={`text-xl font-bold ${textPrimary}`}>à¸à¸²à¸£à¸•à¸±à¹‰à¸‡à¸„à¹ˆà¸²à¸à¸²à¸£à¹à¸ªà¸”à¸‡à¸œà¸¥</h2>
                    </div>
                    <p className={`text-sm mb-8 ml-11 ${textSecondary}`}>à¸›à¸£à¸±à¸šà¹à¸•à¹ˆà¸‡ Theme à¹à¸¥à¸°à¸ à¸²à¸©à¸²à¸•à¸²à¸¡à¸•à¹‰à¸­à¸‡à¸à¸²à¸£</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="bg-light-surface-2/50 dark:bg-dark-bg/50 rounded-2xl p-6 border border-light-border/40 dark:border-dark-border/40">
                            <div className="flex items-center gap-2.5 mb-1">
                                ...
                                <h3 className={`font-bold ${textPrimary}`}>à¸˜à¸µà¸¡à¸«à¸™à¹‰à¸²à¸ˆà¸­</h3>
                            </div>
                            <p className={`text-xs mb-5 ${textSecondary}`}>à¹€à¸¥à¸·à¸­à¸à¸£à¸°à¸«à¸§à¹ˆà¸²à¸‡à¹‚à¸«à¸¡à¸”à¸ªà¸§à¹ˆà¸²à¸‡à¹à¸¥à¸°à¸¡à¸·à¸”</p>
                            ...
                            <p className={`text-xs mt-4 text-center ${textSecondary}`}>
                                à¸›à¸±à¸ˆà¸ˆà¸¸à¸šà¸±à¸™: <span className={`font-semibold ${textPrimary}`}>{currentTheme === 'light' ? 'Light' : 'Dark'}</span>
                            </p>
                        </div>
                        ...
                        <div className="bg-light-surface-2/50 dark:bg-dark-bg/50 rounded-2xl p-6 border border-light-border/40 dark:border-dark-border/40">
                            <div className="flex items-center gap-2.5 mb-1">
                                ...
                                <h3 className={`font-bold ${textPrimary}`}>à¸ à¸²à¸©à¸²</h3>
                            </div>
                            <p className={`text-xs mb-5 ${textSecondary}`}>à¹€à¸¥à¸·à¸­à¸à¸ à¸²à¸©à¸²à¸—à¸µà¹ˆà¸•à¹‰à¸­à¸‡à¸à¸²à¸£à¹à¸ªà¸”à¸‡à¸œà¸¥</p>
                            ...
                            <p className={`text-xs mt-4 text-center ${textSecondary}`}>
                                à¸›à¸±à¸ˆà¸ˆà¸¸à¸šà¸±à¸™: <span className={`font-semibold ${textPrimary}`}>{currentLanguage === 'th' ? 'à¹„à¸—à¸¢' : 'English'}</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                {activeTab !== 'personal-info' && (
                    <div className="flex items-center justify-end gap-3 mb-6 animate-fade-in">
                        <button className={btnOutline}>à¸¢à¸à¹€à¸¥à¸´à¸</button>
                        <button
                            onClick={handleSave}
                            disabled={saving}
                            className="px-5 py-2.5 text-sm font-semibold rounded-xl bg-orange-primary hover:bg-blue-primary text-white shadow-md hover:/40 transition-all duration-200 flex items-center gap-2 disabled:opacity-60"
                        >
                            {(() => {
                            ...
                            {saving ? 'à¸à¸³à¸¥à¸±à¸‡à¸šà¸±à¸™à¸—à¸¶à¸...' : 'à¸šà¸±à¸™à¸—à¸¶à¸à¸à¸²à¸£à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¹à¸›à¸¥à¸‡'}
                        </button>
                    </div>
                )}
