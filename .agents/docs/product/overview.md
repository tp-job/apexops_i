...
> a directory layout that no longer exist. See [`ui-reset-2026-07-24.md`](../archive/ui-reset-2026-07-24.md)
> and [`user-flow.md`](user-flow.md) for the full history and the rebuild plan.
