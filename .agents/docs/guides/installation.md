...
หรือดูคู่มือเพิ่มเติมใน [DATABASE_SETUP.md](../architecture/database.md)
...
1. อ่าน [Overview](../product/overview.md) เพื่อเข้าใจโปรเจกต์
2. ดู [Features](../product/features.md) เพื่อรู้ฟีเจอร์ทั้งหมด
3. อ่าน [API Documentation](../architecture/api-reference.md) สำหรับ API endpoints
4. ดู [Project Structure](../architecture/project-structure.md) เพื่อเข้าใจโครงสร้าง
...
2. อ่าน [Database setup](../architecture/database.md)
3. ถ้าต่อ Postgres ไม่ได้ ดู [postgresql-fix](postgresql-fix.md) และ [psql-connection](psql-connection.md)
